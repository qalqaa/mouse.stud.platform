...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'dist'), BASE_DIR / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
PUBLIC_ASSETS_PATH = BASE_DIR / "static" / "public"

DJANGO_VITE_DEV_MODE = DEBUG

STATIC_ROOT = BASE_DIR / "collectedstatic"

STATICFILES_DIRS = [DJANGO_VITE_ASSETS_PATH, PUBLIC_ASSETS_PATH]
